...
#define MBED_CONF_APP_WIFI_PASSWORD                                           "1029384756"                                                                                     // set by application
#define MBED_CONF_APP_WIFI_SSID                                               "Racket"                                                                                         // set by application
...
#define MBED_CONF_NSAPI_DEFAULT_WIFI_PASSWORD                                 "1029384756"                                                                                     // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SECURITY                                 WPA_WPA2                                                                                         // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SSID                                     "Racket"                                                                                         // set by application[*]
